...
//Application Title
define('APP_TITLE', 'MR NEXT Manager');
...
$auth_users = array(
    'admin' => '$2y$10$.wmU.C6EQhURT5YDfTYrh.hlCbxc/QX9nhXLQMKdfFxWE3ohVQfDW', 
);
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="tg://resolve?domain=dangersupportbot" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">DangerOP</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="" target="_blank" class="app-v-title"> Tiny File Manager <?php echo VERSION; ?></a></h3></p>
                        <p>Author: Prasath Mani</p>
                        <p>Mail Us: <a href="mailto: spydangeryt@gmail.com">spydangeryt@gmail.com</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
...
<head>
    ...
    <meta name="author" content="DangerOP">
