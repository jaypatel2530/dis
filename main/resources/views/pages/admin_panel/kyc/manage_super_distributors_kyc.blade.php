@extends('layouts.app')
@section('title','Super Distributors Pending KYC')
@section('content')
<!-- Begin Page Content -->
            ...
            <div class="card shadow mb-4" id="ub-card">
                <div class="card-header py-3 ">
                  <h6 class="m-0 font-weight-bold text-whitee">
                      <i class="fas  fa-address-card pr-2"></i>Super Distributors Pending KYC</h6>
                </div>
                <div class="card-body">
...
$(document).ready(function() {
    oTable = $('#datatable_ajax').DataTable({
        ...
        "ajax": {
            "url": "{{ route('get:super_distributors_pending_kyc_data')}}",
            "type": 'GET',
            "data": function (d) { }
        },
        "columns": [
