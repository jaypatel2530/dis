@extends('layouts.app')
@section('title','Retailers Pending KYC')
@section('content')
<!-- Begin Page Content -->
            ...
            <div class="card shadow mb-4" id="ub-card">
                <div class="card-header py-3 ">
                  <h6 class="m-0 font-weight-bold text-whitee">
                      <i class="fas  fa-address-card pr-2"></i>Retailers Pending KYC</h6>
                </div>
                <div class="card-body">
      ...
      <div class="modal-body">
        <div class="row">
            ...
            <div class="col-md-12 mt-2">
                Retailer Name   : <span id="agent_name"></span><br>
                Retailer Mobile : <span id="agent_mobile"></span><br>
                PAN Number : <span id="pan_number"></span><br>
                Aadhaar Number : <span id="aadhaar_number"></span><br>
                Date Of Birth : <span id="date_of_birth"></span><br>
            </div>
        </div>
      </div>
...
$(document).ready(function() {
    oTable = $('#datatable_ajax').DataTable({
        ...
        "ajax": {
            "url": "{{ route('get:retailers_pending_kyc_data')}}",
              "type": 'GET',
              data: function (d) {
              }
        },
