@extends('layouts.app')
@section('title','Manage Super Distributors')
@section('content')
<div class="container-fluid">
  <div class="card shadow mb-4" id="ub-card">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold">
          <i class="fas fa-user pr-2"></i>Manage Super Distributors</h6>
    </div>
    <div class="card-body">
...
$(document).ready(function() {
    oTable = $('#datatable_ajax').DataTable({
        ...
        "dom": 'lfrtip',
        "ajax": {
            "url": "{{ route('get:manage_super_distributors_data')}}",
              "type": 'GET',
              data: function (d) {
              }
        },
        "columns": [
            ...
            { "data": 'id', "name": 'id', "sClass": "" , "render": function (data, type, full, meta) {
                var action = "";
                action += '<a href={{url("passbook/super-distributor-passbook")}}/' + full.mobile + '  class="btn btn-success btn-sm" title="Passbook">Passbook</a>&nbsp;';
                return action;    }
            },
