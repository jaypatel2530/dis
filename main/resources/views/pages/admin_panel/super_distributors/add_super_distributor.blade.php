@extends('layouts.app')
@section('title','Add Super Distributor')
@section('customcss') 
@endsection
@section('content')
<!-- Begin Page Content -->
  ...
  <div class="card shadow mb-4" id="ub-card">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold">
          <i class="fas fa-user-plus pr-2"></i> Add Super Distributor</h6>
    </div>
    <div class="card-body">
      
        <div class="col-md-12">
            <form action="{{ route('post:add_super_distributor') }}" method="post" enctype="multipart/form-data">
              @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <input type="email" class="form-control" id="email" name="email" value="{{ old('address') }}" 
