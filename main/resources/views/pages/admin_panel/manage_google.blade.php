@extends('layouts.app')
@section('title','Manage Google Code')
@section('content')
<div class="container-fluid">
  <div class="card shadow mb-4" id="ub-card">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold">
          <i class="fas fa-user pr-2"></i>Manage Google Code</h6>
    </div>
    <div class="card-body">
...
$(document).ready(function() {
    oTable = $('#datatable_ajax').DataTable({
        ...
        "dom": 'lfrtip',
        "ajax": {
            "url": "{{ route('get:manage_google_code_data')}}",
              "type": 'GET',
              data: function (d) {
              }
        },
        "columns": [
            ...
            { "data": 'id', "name": 'id', "sClass": "" , "render": function (data, type, full, meta) {
                var action = "";
                action += '<a href={{url("delete-google-code")}}/' + full.id + '  class="btn btn-success btn-sm" title="Passbook">Delete</a>&nbsp;';
                return action;    }
            },
