@extends('layouts.app')
@section('title','Purchase Retailer IDs Report')
@section('content')
<!-- Begin Page Content -->
            ...
            <div class="card shadow mb-4" id="ub-card">
                <div class="card-header py-3 ">
                  <h6 class="m-0 font-weight-bold">
                      <i class="fas fa-book pr-2"></i>Purchase Retailer IDs Report</h6>
                </div>
                <div class="card-body">
...
$(document).ready(function() {
    oTable = $('#datatable_ajax').DataTable({
        ...
        "ajax": {
            "url": "{{ route('get:purchase_retailer_ids_report_data')}}",
            "type": 'GET',
            "data": function (d) {
        ...
        "columns": [
            ...
            {"data": "current_stock"}, 
            // {"data": "txn_type"},
            {"data": 'txn_type', name: 'txn_type' ,"render": function (data, type, full, meta) {
                    var action = "";
                    
                    switch (data)
                    {
                        case ('Debit'):
                                action = '<h6><span class="badge badge-danger">Debit</span></h6>';
                                break;
                        case ('Credit'):
                                action = '<h6><span class="badge badge-success">Credit</span></h6>';
                                break;
                        default:
                                action = data
                                break;
