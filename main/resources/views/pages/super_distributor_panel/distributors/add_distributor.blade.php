...
<div class="container-fluid">
  <div class="card shadow mb-4" id="ub-card">
    ...
    <div class="card-body">
        ...
        <div class="col-md-12">
            <form action="{{ route('post:sd_add_distributor') }}" method="post" enctype="multipart/form-data">
              @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6 mb-4">
                        ...
                        <div class="input-group input-group-alternative">
                            ...
                            <input class="form-control datepicker"  type="text"  id="dob" name="dob" value="{{ old('pincode') }}" 
