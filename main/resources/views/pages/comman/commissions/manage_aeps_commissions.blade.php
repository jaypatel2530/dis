@extends('layouts.app')
@section('title','Manage Aeps Commissions')
@section('content')
  ...
  <div class="card shadow mb-4" id="ub-card">
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold">
          <i class="fas fa-user pr-2"></i>Manage Aeps Commissions</h6>
    </div>
    <div class="card-body">
        
        <form action="{{ route('post:add_aeps_commission') }}" method="post" enctype="multipart/form-data">
            @csrf
...
$(document).ready(function() {
    oTable = $('#datatable_ajax').DataTable({
        ...
        "dom": 'lfrtip',
        "ajax": {
            "url": "{{ route('get:manage_aeps_commissions')}}",
              "type": 'GET',
              data: function (d) {
