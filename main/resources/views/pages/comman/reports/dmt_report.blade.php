            ...
            <div class="card shadow mb-4" id="ub-card">
                <div class="card-header py-3 ">
                  <h6 class="m-0 font-weight-bold">
                      <i class="fas fa-book pr-2"></i>DMT Report</h6>
                </div>
                <div class="card-body">
                    ...
                    <div id="amount_print_section">
                        ...
                        <span class="amount_print" id="print_total_success_fee">Total Fee : <small><i class="fas fa-fw fa-rupee-sign"></i></small>0.00</span>
                    </div>   
    ...
    oTable = $('#datatable_ajax').DataTable({
        ...
        "ajax": {
            ...
            "dataSrc": function (json) {
                ...
                $("#print_total_success_fee").html('Total Fee : <small><i class="fas fa-fw fa-rupee-sign"></i></small>'+parseFloat(json.total_success_fee).toFixed(2));
                return json.data;
            },
        },
        "columns": [
