            ...
            <div class="card shadow mb-4" id="ub-card">
                <div class="card-header py-3 ">
                  <h6 class="m-0 font-weight-bold">
                      <i class="fas fa-book pr-2"></i>Commission Report</h6>
                </div>
                <div class="card-body">
...
$(document).ready(function() {
    oTable = $('#datatable_ajax').DataTable({
        ...
        "ajax": {
            "url": "{{ route('get:commission_report_data')}}",
            "type": 'GET',
            "data": function (d) {
        ...
        "columns": [
            ...
            {"data": 'txn_event', name: 'txn_event' ,"render": function (data, type, full, meta) {
                    var action = "";
                    
                    if(data == 'QUICKDMT') {
                        action = 'Money Transfer Rs.' + full. txn_amount;
                    }
                    else if(data == 'DTH' || data == 'PREPAID') {
                        action = 'Recharge Of Rs.' + full.txn_amount;
                    }
                    else if(data == 'POSTPAID' || data == 'WATER' || data == 'ELECTRICITY' || data == 'LANDLINE' || data == 'GAS'){
                        action = 'Bill Payment Of Rs.' + full.txn_amount;
                    }
                    else {
                        action = data +' Of Rs.'+ full.txn_amount;
                    }
                    return action;
                } 
            },
