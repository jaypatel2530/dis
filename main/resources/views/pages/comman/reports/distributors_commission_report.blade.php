@extends('layouts.app')
@section('title','Distributors Commission Report')
@section('content')
<!-- Begin Page Content -->
            ...
            <div class="card shadow mb-4" id="ub-card">
                <div class="card-header py-3 ">
                  <h6 class="m-0 font-weight-bold">
                      <i class="fas fa-book pr-2"></i>Distributors Commission Report</h6>
                </div>
                <div class="card-body">
...
$(document).ready(function() {
    oTable = $('#datatable_ajax').DataTable({
        ...
        "ajax": {
            "url": "{{ route('get:distributors_commission_report_data')}}",
            "type": 'GET',
            "data": function (d) {
